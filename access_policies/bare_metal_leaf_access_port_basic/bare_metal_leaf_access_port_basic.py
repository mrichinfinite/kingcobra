# Basic access policies for connecting a bare metal (physical) server/host to ACI via leaf access port. Change the variables as needed for your environment. Tested and verified on ACI software version .
