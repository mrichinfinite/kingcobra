# Basic access policies for connecting a bare metal (physical) endpoint to ACI via vPC. Change the variables as needed for your environment. Tested and verified on ACI software version 5.2(4e).
