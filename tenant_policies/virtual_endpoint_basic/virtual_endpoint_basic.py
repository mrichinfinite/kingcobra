# Basic tenant policies for connecting a virtual server/host to ACI via leaf access port. Change the variables as needed for your environment. Tested and verified on ACI software version 5.2(5c).
...
ls = cobra.mit.session.LoginSession('https://10.122.188.173', 'admin', 'cisco!123')
